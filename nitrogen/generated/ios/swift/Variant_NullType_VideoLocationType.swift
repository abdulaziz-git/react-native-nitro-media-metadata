///
/// Variant_NullType_VideoLocationType.swift
 ...
 */
@frozen
public indirect enum Variant_NullType_VideoLocationType {
  case first(NullType)
  case second(VideoLocationType)
}

public extension Variant_NullType_VideoLocationType {
