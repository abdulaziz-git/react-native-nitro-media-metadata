...
namespace margelo::nitro::nitromediametadata {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitromediametadata/Variant_NullType_Boolean;";
  ...
  namespace JVariant_NullType_Boolean_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitromediametadata/Variant_NullType_Boolean$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitromediametadata/Variant_NullType_Boolean$Second;";
